...
public class NopDeCuongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        setupClick();
        setupUploadRecyclerview();
        setupReportFileRecyclerview();
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PICK_FILE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            String fileName = nopDeCuongViewModel.safeFileName(nopDeCuongViewModel.getFileName(fileUri));
            String fileType = context.getContentResolver().getType(fileUri);
            File file = null;
            try {
                file = nopDeCuongViewModel.getFileFromUri(fileUri);
            } catch (IOException e) {
    ...
    void setupReportFileRecyclerview() {
